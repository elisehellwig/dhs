...
plotint(p8f, 'Nigeria', 'hw8', reverse=TRUE, type='RF Prediction', range=c(-2.5,-0.25), breaks=6)

resid8 <- p8f - ni8
plotint(resid8, 'Nigeria', 'hw8', reverse=TRUE, type='RF Residuals', colorpalette='RdBu', breaks=8, range=c(-0.16,0.16))
